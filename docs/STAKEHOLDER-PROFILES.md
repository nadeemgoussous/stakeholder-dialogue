...
This document contains detailed profiles for all stakeholder groups implemented in the Scenario Dialogue Tool.

## Core Stakeholder Groups

The tool implements seven stakeholder groups from IRENA's Participatory Processes Toolkit, plus two additional groups commonly encountered in energy planning:

1. **Policy Makers & Regulators** (from toolkit)
2. **Grid Operators** (from toolkit)
3. **Industry & Business** (from toolkit)
4. **Public & Communities** (from toolkit)
5. **CSOs & NGOs** (from toolkit)
6. **Scientific Institutions** (from toolkit)
7. **Financial Institutions** (from toolkit)
8. **Regional Bodies** (added - e.g., power pools, regional integration bodies)
9. **Development Partners** (added - e.g., bilateral/multilateral donors)
...
interface ResponseTemplate {
  condition: string;           // e.g., "highRenewableShare"
...
```typescript
const policyMakers: StakeholderProfile = {
  id: 'policy-makers',
  ...
  concernTriggers: [
    {
      ...
      threshold: 10000,
      direction: 'above',
      concernText: 'The total investment requirement is substantial.',
    ...
    },
    {
      ...
      threshold: 2000,
      direction: 'below',
      concernText: 'Job creation appears limited.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 5000,
      direction: 'above',
      praiseText: 'Strong job creation potential supports employment goals.'
    },
    {
      metric: 'emissions.reductionPercent2030',
      threshold: 20,
      direction: 'above',
      praiseText: 'Significant emissions reduction demonstrates climate leadership.'
    }
  ],
...
```typescript
const gridOperators: StakeholderProfile = {
  id: 'grid-operators',
  name: 'Grid Operators',
  ...
  concernTriggers: [
    {
      ...
      threshold: 70,
      direction: 'above',
      concernText: 'Very high renewable penetration requires significant grid upgrades.',
    ...
    },
    {
      ...
      threshold: 100,
      direction: 'below',
      concernText: 'Limited battery storage may constrain renewable integration.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 500,
      direction: 'above',
      praiseText: 'Strong interconnector expansion enables regional balancing.'
    },
    {
      metric: 'supply.capacity.battery.2040',
      threshold: 300,
      direction: 'above',
      praiseText: 'Adequate battery deployment supports system flexibility.'
    }
  ]
};
```
...
```typescript
const industry: StakeholderProfile = {
  id: 'industry',
  ...
  concernTriggers: [
    {
      ...
      threshold: 3000,
      direction: 'above',
      concernText: 'High investment costs may translate to higher industrial tariffs.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 500,
      direction: 'above',
      praiseText: 'Large solar pipeline creates opportunities for local businesses.'
    },
    {
      metric: 'jobs.construction.total',
      threshold: 10000,
      direction: 'above',
      praiseText: 'Significant construction activity benefits local contractors.'
    }
  ]
};
```
...
```typescript
const publicCommunities: StakeholderProfile = {
  id: 'public',
  ...
  concernTriggers: [
    {
      ...
      threshold: 10000,
      direction: 'above',
      concernText: 'Large land requirements affect many communities.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 3000,
      direction: 'above',
      praiseText: 'Permanent jobs provide stable employment for communities.'
    }
  ]
};
```
...
```typescript
const csosNgos: StakeholderProfile = {
  id: 'csos-ngos',
  name: 'CSOs & NGOs',
  ...
  concernTriggers: [
    {
      ...
      threshold: 30,
      direction: 'above',
      concernText: 'Remaining emissions in 2050 may be incompatible with net-zero.',
    ...
    },
    {
      ...
      threshold: 50,
      direction: 'below',
      concernText: 'Renewable share appears unambitious.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 80,
      direction: 'above',
      praiseText: 'Deep emissions reduction shows serious climate commitment.'
    }
  ]
};
```
...
```typescript
const scientificInstitutions: StakeholderProfile = {
  id: 'scientific',
  ...
  concernTriggers: [
    {
      ...
      threshold: 25,
      direction: 'above',
      concernText: 'Solar growth rate exceeds historical precedents.',
...
```typescript
const financialInstitutions: StakeholderProfile = {
  id: 'finance',
  ...
  concernTriggers: [
    {
      ...
      threshold: 5000,
      direction: 'above',
      concernText: 'Large financing requirements need clear mobilization strategy.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 500,
      direction: 'above',
      praiseText: 'Significant solar pipeline is increasingly bankable.'
    }
  ]
};
```
...
```typescript
const regionalBodies: StakeholderProfile = {
  id: 'regional-bodies',
  ...
  concernTriggers: [
    {
      ...
      threshold: 30,
      direction: 'above',
      concernText: 'High import dependence raises regional coordination questions.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 2000,
      direction: 'above',
      praiseText: 'Export potential positions country as regional clean energy hub.'
    }
  ]
};
```
...
```typescript
const developmentPartners: StakeholderProfile = {
  ...
  concernTriggers: [
    {
      ...
      threshold: 4000,
      direction: 'above',
      concernText: 'Large investment requirements raise debt sustainability questions.',
    ...
    },
    {
      ...
      threshold: 80,
      direction: 'below',
      concernText: 'Electrification trajectory may fall short of universal access goals.',
    ...
    },
    {
      ...
      threshold: 50,
      direction: 'above',
      concernText: 'High sovereign guarantee requirements create fiscal risk.',
  ...
  positiveIndicators: [
    {
      ...
      threshold: 30,
      direction: 'above',
      praiseText: 'Strong emissions reduction supports climate finance eligibility.'
    },
    {
      metric: 'investment.privateSectorShare',
      threshold: 40,
      direction: 'above',
      praiseText: 'Significant private sector mobilization reduces public financing burden.'
    }
  ]
};
```
...
These profiles are designed to be general-purpose and can be customized for:

- **Different regions**: Adjust thresholds and priorities based on regional context
- **Different sectors**: Adapt for water, transport, or industrial planning
- **Different policy environments**: Modify concern triggers based on local regulations

### Adding New Stakeholder Groups

To add a new stakeholder group:

1. Define the profile following the `StakeholderProfile` interface
2. Add appropriate `concernTriggers` based on available metrics
3. Add `positiveIndicators` for balanced responses
4. Create at least one `responseTemplate` for common scenarios
5. Add the profile to `src/data/stakeholder-profiles.ts`
6. Create or source an appropriate icon

### Modifying Thresholds

Thresholds in `concernTriggers` and `positiveIndicators` should be:
- Based on empirical evidence where possible
- Calibrated to the local context
- Tested with actual scenario data
